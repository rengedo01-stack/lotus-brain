...
The CI database matrix starts with purchase posting, purchase cancellation, production lifecycle, and stocktake posting because they are the immediate inventory prerequisites for future posted-purchase correction work. Add later real-database proofs to the target manifest; do not replace them with skipped or weakened tests.
