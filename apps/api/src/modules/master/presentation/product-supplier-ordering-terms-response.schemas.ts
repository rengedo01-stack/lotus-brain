...
export const productSupplierOrderingTermsSchema = {
  type: "object" as const,
  additionalProperties: false,
  required: ["id", "relationshipId", "minimumOrderQuantity", "orderMultipleQuantity", "version", "createdAt", "updatedAt"],
  properties: {
    id: { type: "string" as const, minLength: 1 },
    relationshipId: { type: "string" as const, minLength: 1 },
    minimumOrderQuantity: { oneOf: [positiveQuantitySchema, { type: "null" as const }] },
    orderMultipleQuantity: { oneOf: [positiveQuantitySchema, { type: "null" as const }] },
...
export const productSupplierOrderingTermsContextSchema = {
  type: "object" as const,
  additionalProperties: false,
  required: ["relationship", "terms"],
  properties: {
    relationship: relationshipSchema,
    terms: { oneOf: [productSupplierOrderingTermsSchema, { type: "null" as const }] },
  },
};

export const productSupplierOrderingTermsListSchema = {
  type: "array" as const,
  items: productSupplierOrderingTermsContextSchema,
};
