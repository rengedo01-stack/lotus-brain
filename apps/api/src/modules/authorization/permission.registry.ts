export const Permissions = Object.freeze({
  ...
  PURCHASE_REVERSE_POSTED: "purchase.reversePosted",
...
export const PERMISSION_REGISTRY: Readonly<Record<PermissionCode, PermissionMetadata>> = Object.freeze({
  ...
  [Permissions.INVENTORY_READ]: Object.freeze({ description: "Read current inventory and inventory history.", customRoleAssignable: true }),
  [Permissions.REPLENISHMENT_MANAGE]: Object.freeze({ description: "Create, recalculate, or dismiss replenishment recommendations.", customRoleAssignable: true }),
  ...
  [Permissions.PURCHASE_REVERSE_POSTED]: Object.freeze({ description: "Reverse already posted purchases as audited corrections.", customRoleAssignable: false }),
